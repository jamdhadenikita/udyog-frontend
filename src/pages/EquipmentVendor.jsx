...
const EquipmentVendor = () => {
  ...
  const filteredData = equipmentData.filter((vendor) =>
    ...
    <section className="">
      ...
      <div className="flex items-center justify-center p-4">
        <div className="relative max-w-2xl w-full">
          {/* <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none bg-white">
            <CiSearch className="h-5 w-5 text-gray-400" />
          </div> */}
          <input
            type="text"
            className="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg placeholder-gray-400 bg-white"
